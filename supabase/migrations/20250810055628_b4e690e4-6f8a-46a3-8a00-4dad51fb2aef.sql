-- Retry migration: fix cron.schedule command quoting

-- Ensure notifications_log exists (idempotent)
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
      ...
      AND polname = 'Users can view org notifications'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
      AND tablename = 'notifications_log' 
      AND polname = 'System can insert notifications logs'
  ) THEN
