...
export const ContactQuickMetrics = memo(({ contacts }: ContactQuickMetricsProps) => {
  // OPTIMIZACIÓN: Memorizar cálculos pesados
...
ContactQuickMetrics.displayName = 'ContactQuickMetrics'
