...
interface PersonRowOptimizedProps {
  index: number
  style: CSSProperties
  data: {
    persons: Person[]
...
const PersonRowOptimized = memo(({ index, style, data }: PersonRowOptimizedProps) => {
  ...
  const handleViewPerson = () => navigate(`/contacts/${person.id}`)
...
PersonRowOptimized.displayName = 'PersonRowOptimized'

export { PersonRowOptimized }
