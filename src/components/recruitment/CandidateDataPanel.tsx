...
export function CandidateDataPanel({ candidate, open, onOpenChange }: CandidateDataPanelProps) {
      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-6">
          <TabsList className="grid w-full grid-cols-6">
            ...
            <TabsTrigger value="proceso" className="flex items-center space-x-2">
            ...
            <TabsTrigger value="referencias" className="flex items-center space-x-2">
              <Users className="w-4 h-4" />
              <span>Referencias</span>
            </TabsTrigger>
            <TabsTrigger value="entrevistas" className="flex items-center space-x-2">
          ...
          <TabsContent value="entrevistas" className="mt-6">
            <Card>
              ...
              <CardContent>
                <p className="text-center text-muted-foreground py-8">
                  Integración con sistema de entrevistas en desarrollo
                </p>
              </CardContent>
            </Card>
          </TabsContent>
