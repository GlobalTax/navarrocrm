                        ...
                        <div key={day.day.toString()} className="space-y-1.5">
                          {day.events.slice(0, 2).map((event) => (
                            <div
                              ...
                              className="flex flex-col items-start gap-1 rounded-lg border bg-muted/50 p-2 text-xs leading-tight cursor-pointer hover:bg-muted/70 transition-colors"
                            >
                              ...
                              {event.client && (
                                <p className="leading-none text-blue-600 text-xs">
                                  {event.client}
                                </p>
                              )}
                            </div>
