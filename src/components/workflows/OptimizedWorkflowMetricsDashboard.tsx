...
interface OptimizedWorkflowMetricsDashboardProps {
  ...
  <Card className="transition-all hover:shadow-md">
    <CardContent className="p-6">
      <div className="flex items-start justify-between">
        ...
        <div className={`p-3 rounded-lg ${bgColor} ml-4`}>
...
const OptimizedWorkflowMetricsDashboard = React.memo<OptimizedWorkflowMetricsDashboardProps>(({ 
  metrics, 
  isLoading 
}) => {
  const stats = useMemo(() => {
...
OptimizedWorkflowMetricsDashboard.displayName = 'OptimizedWorkflowMetricsDashboard'

export { OptimizedWorkflowMetricsDashboard }
