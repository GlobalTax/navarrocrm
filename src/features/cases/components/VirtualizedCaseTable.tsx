...
export function VirtualizedCaseTable({
  cases,
  onView,
  onEdit,
  onDelete,
  ...
  const renderCaseRow = (case_: Case, index: number) => (
    <TableRow key={case_.id} className="border-b">
      ...
      <CardContent>
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            Prueba ajustando los filtros o criterios de búsqueda.
          </p>
        </div>
      </CardContent>
    </Card>
