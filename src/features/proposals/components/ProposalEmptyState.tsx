...
import { FileText, Plus, Search, Building, Target, TrendingUp } from 'lucide-react'
...
export function ProposalEmptyState({ hasFilters, onCreateProposal }: ProposalEmptyStateProps) {
  if (hasFilters) {
    return (
    ...
    <div className="text-center py-20 px-6">
      <div className="max-w-lg mx-auto">
        ...
        <h3 className="text-2xl font-bold text-gray-900 mb-4">
          ¡Impulsa tu negocio con propuestas ganadoras!
        </h3>
        <p className="text-gray-600 mb-8 text-lg leading-relaxed">
          Las propuestas son clave para conseguir nuevos clientes. 
          Crea tu primera propuesta profesional y cierra más deals.
        </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-100">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm text-gray-500">
            <div className="flex flex-col items-center">
              ...
              <span>Propuestas profesionales</span>
            </div>
            <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <span>Incrementa conversión</span>
            </div>
          </div>
        </div>
      </div>
